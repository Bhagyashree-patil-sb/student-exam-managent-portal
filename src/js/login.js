...
// Autofill the name and father's name based on selected USN
...
function handleLogin(event) {
    ...
    localStorage.setItem('loggedInStudent', JSON.stringify(studentData)); // Store data in localStorage
...
// Populate the USN dropdown on page load
populateUSNOptions();
